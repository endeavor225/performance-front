  ...
  <q-layout view="lHh Lpr lFf">
    <q-header elevated>
      <q-toolbar class="bg-white">
        ...
        <q-toolbar-title class="text-primary"> Performance </q-toolbar-title>
                ...
                >
                  <div class="col-12">
                    <q-item
                      ...
                      v-ripple
                      @click="onLire(item)"
                      :class="{ 'bg-teal-1': !item.lu }"
                    >
                      <q-item-section>
                        <q-item-label caption lines="3">
                          <q-avatar size="8px" :color="item.color" />
                          {{ item.titre }}
                        </q-item-label>
                      </q-item-section>
                      <q-item-section side>
        ...
        <q-list padding class="menu-list q-mt-lg q-ml-lg">
          ...
          >
            ...
            >
              ...
              <q-item-section> Liste des Missions </q-item-section>
            </q-item>
          </a>
          ...
          >
            ...
            >
              ...
              <q-item-section> Missions </q-item-section>
            </q-item>
          </a>

          <a
            @click="$router.push('/fonctionnalite')"
            style="text-decoration: none; color: white"
          >
            <q-item
              clickable
            ...
            >
              ...
              <q-item-section> Fonctionnalités </q-item-section>
            </q-item>
          </a>

          <a
            @click="$router.push('/tache')"
            style="text-decoration: none; color: white"
          >
            <q-item
              clickable
          ...
          >
            ...
            >
              ...
              <q-item-section> Sous-tâches </q-item-section>
            </q-item>
          </a>
          ...
          >
            ...
            >
              ...
              <q-item-section> Évaluations </q-item-section>
            </q-item>
          </a>
    ...
    <q-footer reveal class="bg-white no-shadow"> ok </q-footer>
  </q-layout>
</template>
  ...
  setup() {
    ...
    onMounted(async () => {
      if (token) {
        ...
        await getItems();
        socket.on('notifications', async (res) => {
          console.log(res)
          await getItems();
        });
    ...
    let getItems = async (replace) => {
      ...
      try {
        ...
        let count =
          await await instance.appContext.app.config.globalProperties.$api({
